...
// ---- security.js をモック ----
jest.unstable_mockModule('../../proxy/app/security.js', () => ({
  allowedIp: jest.fn(),
  denyDomain: jest.fn(),
}));
...
const { allowedIp, denyDomain } = await import('../../proxy/app/security.js');
const { swallow, proxyConnect } = await import('../../proxy/app/index.js');
